...
export const TERRAIN_COLORS: Record<Terrain, string> = {
  ...
  relief_very_low: 'rgb(65, 112, 83)',
  relief_low: 'rgb(94, 139, 82)',
  relief_low_mid: 'rgb(131, 158, 78)',
  relief_mid: 'rgb(167, 165, 83)',
  relief_high_mid: 'rgb(173, 139, 78)',
  relief_high: 'rgb(158, 111, 74)',
  relief_mountain: 'rgb(132, 118, 111)',
  relief_peak: 'rgb(218, 218, 208)',
